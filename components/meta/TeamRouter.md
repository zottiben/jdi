...
| Team | Path |
|------|------|
| Engineering | `.claude/jedi/teams/engineering.md` |
| Product & Research | `.claude/jedi/teams/product-research.md` |
| Quality Assurance | `.claude/jedi/teams/quality-assurance.md` |
| DevOps | `.claude/jedi/teams/devops.md` |
| Micro-Management | `.claude/jedi/teams/micro-management.md` |
